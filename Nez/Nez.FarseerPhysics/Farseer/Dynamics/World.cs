...
namespace FarseerPhysics.Dynamics {
	...
	public class World {
		...
		private CircleShape _tempOverlapCircle = new CircleShape();
		...
		private void Solve(ref TimeStep timeStep) {
		...
		private void SolveTOI(ref TimeStep timeStep) {
...
#pragma warning disable CS0162
		...
		public void QueryCircle(Vector2 center, float radius, List<Fixture> fixtures) {
			...
			AABB aabb;
			Vector2 d = new Vector2(radius, radius);
