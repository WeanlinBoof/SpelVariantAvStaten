...
namespace FarseerPhysics.Dynamics {
	...
	public class Fixture : IDisposable {
		...
		[ThreadStatic] private static int _fixtureIdCounter;
		...
		private void Refilter() {
			...
			DynamicTreeBroadPhase broadPhase = world.ContactManager.BroadPhase;
		...
		private void RegisterFixture() {
			...
			if (Body.Enabled) {
				DynamicTreeBroadPhase broadPhase = Body._world.ContactManager.BroadPhase;
