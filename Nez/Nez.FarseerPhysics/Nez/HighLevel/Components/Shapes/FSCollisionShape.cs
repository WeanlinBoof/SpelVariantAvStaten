	...
	public abstract class FSCollisionShape : Component {
		...
		public FSCollisionShape SetFriction(float friction) {
			...
			if (_fixture != null) {
				...
				Body body = this.GetComponent<FSRigidBody>().Body;
				FarseerPhysics.Dynamics.Contacts.ContactEdge contactEdge = body.ContactList;
				while (contactEdge != null) {
					FarseerPhysics.Dynamics.Contacts.Contact contact = contactEdge.Contact;
