...
namespace Nez.Farseer {
	public static class BodyExt {
		...
		public static List<Fixture> AttachGear(this Body body, float radius, int numberOfTeeth, float tipPercentage,
			...
			Vertices gearPolygon = PolygonTools.CreateGear(FSConvert.DisplayToSim * radius, numberOfTeeth, tipPercentage,
			...
			List<Fixture> fixtures = new List<Fixture> {
				body.AttachPolygon(gearPolygon, density)
			};
			return fixtures;
		}
