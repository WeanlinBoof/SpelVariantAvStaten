...
namespace Nez.ImGuiTools {
	internal class CoreWindow {
		private string[] _textureFilters;
		private float[] _frameRateArray = new float[100];
		private int _frameRateArrayIndex = 0;
		...
		private void DrawSettings() {
			...
			if (ImGui.CollapsingHeader("Core.defaultSamplerState", ImGuiTreeNodeFlags.DefaultOpen)) {
				...
				int currentTextureFilter = (int)Core.DefaultSamplerState.Filter;
