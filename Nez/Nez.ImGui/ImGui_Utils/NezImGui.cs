...
namespace Nez.ImGuiTools {
	public static class NezImGui {
		...
		public static void SmallVerticalSpace() {
		...
		public static void EndBorderedGroup() {
			EndBorderedGroup(new Num.Vector2(3, 2), new Num.Vector2(0, 3));
		}
		...
		public static void EndBorderedGroup(Num.Vector2 minPadding, Num.Vector2 maxPadding = default(Num.Vector2)) {
			...
			Num.Vector4 color = ImGui.GetStyle().Colors[(int)ImGuiCol.Border];
		...
		public static bool LabelButton(string label, string buttonText) {
			...
			bool wasClicked = ImGui.Button(buttonText);
			ImGui.SameLine(0,
		...
		/// </summary>
		/// <returns></returns>
		public static float GetDefaultWidgetHeight() {
			return ImGui.GetFontSize() + ImGui.GetStyle().FramePadding.Y * 2f;
		}
		...
		public static void DisableNextWidget(float widgetCustomHeight = 0) {
			Num.Vector2 origCursorPos = ImGui.GetCursorPos();
			Num.Vector2 widgetSize = new Num.Vector2(ImGui.GetContentRegionAvail().X,
		...
		public static bool CenteredButton(string label, float percentWidth, float xIndent = 0) {
			float buttonWidth = ImGui.GetWindowContentRegionWidth() * percentWidth;
		...
		public unsafe static bool DragScaler(string label, ref ulong value, float speed, int min, int max) {
			...
			IntPtr valuePtr = new IntPtr(&tempValue);
			IntPtr minPtr = new IntPtr(&min);
			IntPtr maxPtr = new IntPtr(&max);
